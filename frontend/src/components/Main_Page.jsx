...
export default function ChatbotPage() {
    const [messages, setMessages] = useState([
        { sender: "bot", text: "Olá! Sou o Shinka Bot, seu Assitente de TI" }
    ]);
    ...
    const handleSend = async ()  => {
        ...
        try {
            ...
            console.error("Error trying to connect with the AI!")
            setMessages(prevMessages => [...prevMessages, { sender: "bot", text: "Desculpe, houve um erro ao conectar aos serviços de IA. Por favor tente novamente!"}]);
        } finally {
            setIsLoading(false);
        }
    };
